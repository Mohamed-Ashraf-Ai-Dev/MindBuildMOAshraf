...
بعد إدخال اسم التطبيق واسم الحزمة، تظهر شجرة Android الفعلية. يمكن إنشاء ملفات ومجلدات، وتحرير ملفات Kotlin وXML وGradle مباشرة، وإضافة صور أو أي موارد من الهاتف إلى المسار الذي تختاره. التعديلات تبقى محليًا داخل الجلسة حتى تختار **رفع المشروع** أو **ابدأ البناء**.

عند اختيار أيقونة تُكتب كملف `app/src/main/res/drawable/app_icon.png` ويتحول Manifest إلى `@drawable/app_icon`. في Release، ارفع JKS/PKCS12 وكلمات المرور واسم المفتاح؛ تُشفّر القيمة داخل المتصفح بـ Libsodium ثم تُرسل إلى GitHub Actions Secrets.

واجهة الهاتف تعرض شريط انتقال مختصر إلى المشروع والملفات والمحرر والبناء، وتحوّل الأعمدة إلى لوحات متتابعة قابلة للتمرير بدل ضغطها في شاشة واحدة.
